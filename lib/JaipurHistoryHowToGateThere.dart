...
class JaipurHistoryHowToGateThere extends StatefulWidget {
  const JaipurHistoryHowToGateThere({super.key});

  @override
  State<JaipurHistoryHowToGateThere> createState() => _JaipurHistoryHowToGateThereState();
}

class _JaipurHistoryHowToGateThereState extends State<JaipurHistoryHowToGateThere> {
  @override
        ...
        children: [SizedBox(
          ...
          Row(
            children: [SizedBox(
              ...
              Text("Jodhpur to jaipur",style: TextStyle(fontSize: 20,),),
            ],
          ),
          SizedBox(
            height: 30,
          ...
          Row(
            children: [
              ...
              Text("5h 15m",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w400),)
            ],
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Text("333 km",style: TextStyle(color: Colors.grey),),
                ],
              ),
              SizedBox(
                width: 150,
