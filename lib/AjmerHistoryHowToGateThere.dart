...
class AjmerHistoryHowtoGateThere extends StatefulWidget {
  const AjmerHistoryHowtoGateThere({super.key});

  @override
  State<AjmerHistoryHowtoGateThere> createState() => _AjmerHistoryHowtoGateThereState();
}

class _AjmerHistoryHowtoGateThereState extends State<AjmerHistoryHowtoGateThere> {
  @override
        ...
        children: [SizedBox(
          ...
          Row(
            children: [SizedBox(
              ...
              Text("Jodhpur to Ajmer",style: TextStyle(fontSize: 20,),),
            ],
          ),
          SizedBox(
            height: 30,
          ...
          Row(
            children: [
              ...
              Text("4h 40m",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w400),)
            ],
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Text("204.2 km",style: TextStyle(color: Colors.grey),),
                ],
              ),
              SizedBox(
                width: 150,
              ),
              Text("3h 496m",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w400),)
            ],
